...
//                }
                ...
                mpaySdk.CashReciptDirectInput(CancelReason: String(mCashCancelMeneu.selectedSegmentIndex + 1), Tid: _tid, AuDate: dateFormat.string(from: mAuDatePicker.date) + "000000", AuNo: mAuNo, Num: mCashTextFieldNumber.text!, Command: Command.CMD_CASH_RECEIPT_CANCEL_REQ, MchData: "", TrdAmt: String(money), TaxAmt: "0", SvcAmt: "0", TaxFreeAmt: "0", InsYn: String(mCashReciptTarget+1), kocesNumber: "",payLinstener: paylistener.delegate as! PayResultDelegate,StoreName: Setting.shared.getDefaultUserData(_key: define.STORE_NAME),StoreAddr: Setting.shared.getDefaultUserData(_key: define.STORE_ADDR),StoreNumber: Setting.shared.getDefaultUserData(_key: define.STORE_BSN),StorePhone: Setting.shared.getDefaultUserData(_key: define.STORE_PHONE),StoreOwner: Setting.shared.getDefaultUserData(_key: define.STORE_OWNER), Products: [])
...
//                }
                ...
                mpaySdk.CashRecipt(Tid: _tid, Money: String(money), Tax: 0, ServiceCharge: 0, TaxFree: 0, PrivateOrBusiness: mCashReciptTarget+1, ReciptIndex: "0000", CancelInfo: mCanCelInfo, OriDate: dateFormat.string(from: mAuDatePicker.date) + "000000", InputMethod: "Msr", CancelReason: String(mCashCancelMeneu.selectedSegmentIndex + 1), ptCardCode: "", ptAcceptNum: "", BusinessData: "", Bangi: "", KocesTradeUnique: "",payLinstener: paylistener.delegate as! PayResultDelegate,StoreName: Setting.shared.getDefaultUserData(_key: define.STORE_NAME),StoreAddr: Setting.shared.getDefaultUserData(_key: define.STORE_ADDR),StoreNumber: Setting.shared.getDefaultUserData(_key: define.STORE_BSN),StorePhone: Setting.shared.getDefaultUserData(_key: define.STORE_PHONE),StoreOwner: Setting.shared.getDefaultUserData(_key: define.STORE_OWNER), Products: [])
